...
const shortcutCards = [
  { to: '/pedidos', label: 'Pedidos', desc: 'Ver y gestionar pedidos', icon: '📦', color: 'from-amber-500 to-orange-600', roles: ['ADMIN', 'PEDIDOS'] },
  { to: '/productos', label: 'Productos', desc: 'Administrar menú', icon: '🍕', color: 'from-red-500 to-rose-600', roles: ['ADMIN', 'STOCK'] },
  { to: '/usuarios', label: 'Usuarios', desc: 'Gestionar accesos', icon: '👥', color: 'from-violet-500 to-purple-600', roles: ['ADMIN'] },
  { to: '/categorias', label: 'Categorías', desc: 'Organizar productos', icon: '📂', color: 'from-emerald-500 to-teal-600', roles: ['ADMIN'] },
  { to: '/ingredientes', label: 'Ingredientes', desc: 'Controlar stock', icon: '🥬', color: 'from-lime-500 to-green-600', roles: ['ADMIN'] },
]
    ...
    <div>
      ...
      <div className="card">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-stone-800 dark:text-stone-100 mb-1">Panel de Administración</h3>
            <p className="text-sm text-stone-500 dark:text-stone-400 leading-relaxed">
              Desde este panel podés gestionar pedidos, productos, usuarios y más. Usá el menú lateral para navegar entre las secciones.
            </p>
